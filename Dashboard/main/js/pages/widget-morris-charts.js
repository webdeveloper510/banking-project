...
$(function(){
  ...
  new Morris.Bar({
    ...
    barColors: ['#405189', '#00c689','#f1536e'],
    gridTextSize: 11,
    hideHover: 'auto',
    resize: true
  });
  ...
  new Morris.Line({
    ...
    ykeys: ['a', 'b', 'c'],
    labels: ['Series A', 'Series B', 'Series C'],
    lineColors: ['#00c689', '#405189', '#fda006'],
    lineWidth: 1,
    ymax: 'auto 100',
    gridTextSize: 11,
    hideHover: 'auto',
  ...
  new Morris.Donut({
    ...
    colors: ['#00c689','#405189','#fda006','#f1536e'],
    resize: true
  });
